...
stopwords1 = ['the', 'and', 'of', 'in', 'to', 'for', 'a', 'on', 'is', 'with', 'at', 'this', 'an', 's', 'es', 'neo', 'index',
             ...
             'time', 'street', 'show', 'support', 'findings', 'strategies', 'government', 'within', 'mobility', 'travel',
             'human', 'co', 'understanding', 'spat', 'rural', 'activity', 'activities', 'network', 'networks', 'transport',
             'transportation', 'location', 'traffic', 'daily', 'among', 'large', 'com', 'geo', 'socio', 'access', 'scale',
             'cluster', 'spaces', 'mobile', 'big', 'di', 'trip', 'trips', 'gender', 'gender', 'relate', 'related', 'sc',
...
def main_proceed():
    ...
    # 6. 指定需要处理的文本列（支持多列）
    columns_to_process = [f'keyword{i}' for i in range(21)] + ['abstract']  # 替换为你的列名列表
    # 7. 处理多列文本数据
